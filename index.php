                    ...
                    <div class="links">
                        ...
                        <div class="feed-chat-notif">
                            ...
                            <div class="feed-notification-box feed-notification-inbox" style="display: none">
                                ...
                                <div style="padding: 10px">
                                    <div class="single-notification">
                                        <img src="https://i.pravatar.cc/150?4" alt="" />
                                        <div class="w-100">
                        ...
                        <div class="header-user-img">
                            <a href="#"><img src="https://i.pravatar.cc/150?7" alt="" class="img-fluid" /></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3 left-bar p-0">
                        ...
                        <div class="side-box">
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?13" alt="" />
                                </div>
                                <div class="info">
                                    <b>Man is mortal</b>
                                    <p class="date">May 14, 2019</p>
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?14" alt="" />
                                </div>
                                <div class="info">
                                    <b>Be honest</b>
                                    <p class="date">May 14, 2019</p>
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?15" alt="" />
                                </div>
                                <div class="info">
                                    <b>Be honest</b>
                                    <p class="date">May 14, 2019</p>
                    ...
                    <div class="col-md-6 feed-bar">
                        <h3 class="act-title">Activity Feed</h3>

                        <div class="post-box" onclick="toggleShow('post-popup-wraper')">
                            <div class="body">
                                <div class="row align-items-center">
                                    <div class="user">
                                        <img src="https://i.pravatar.cc/150?16" alt="" class="img-fluid" />
                                    </div>
                                    <div class="tap">
                            ...
                            <div class="footer">
                                <div class="row">
                                    <div class="icon" aria-label="Upload photo" data-microtip-position="top" role="tooltip"><i class="fas fa-camera"></i></div>
                                    <div class="icon" aria-label="Upload video" data-microtip-position="top" role="tooltip"><i class="fas fa-video"></i></div>
                                </div>
                            </div>
                        </div>
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <div class="feed-post" id="post_' . $row["id"] . '">
            <div class="post-header">
                <div class="user">
                    <img src="https://i.pravatar.cc/150?28" alt="" class="img-fluid" />
                    <div>
            ...
            <div class="content">
                <p style="font-size: 15px; margin-top: 10px">' . $row["text_content"] . '</p>';
...
?>
                    ...
                    <div class="col-md-3 right-bar p-0">
                        ...
                        <div class="side-box">
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?41" alt="" />
                                </div>
                                <div class="info">
                                    <b>Be the best</b>
                                    <p class="date">May 14, 2019</p>
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?42" alt="" />
                                </div>
                                <div class="info">
                                    <b>Be the best</b>
                                    <p class="date">May 14, 2019</p>
                            ...
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?43" alt="" />
                                </div>
                                <div class="info">
                                    <b>Tackle Your closest Spring cleaning</b>
                                    <p class="date">May 14, 2019</p>
                                </div>
                            </div>
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?44" alt="" />
                                </div>
                                <div class="info">
                                    <b>Awesome tips and tricks</b>
                                    <p class="date">May 14, 2019</p>
                                </div>
                            </div>
                            <div class="side-box-post">
                                <div class="cover">
                                    <img src="https://i.pravatar.cc/150?45" alt="" />
                                </div>
                                <div class="info">
                                    <b>I had a tree of money</b>
                                    <p class="date">May 14, 2019</p>
    ...
    <div class="body">
        <div class="top">
            <img src="https://i.pravatar.cc/150?46" alt="" />
            <p>John</p>
        </div>
        <div class="bottom">
            <textarea id="text_content" name="text_content" placeholder="Share what's on your mind..."></textarea>
        </div>
        <div class="bottom">
